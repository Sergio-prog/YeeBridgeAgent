...
from src.agents.bridge_sagent.config import Config
from src.models.messages import ChatRequest

from submodules.moragents_dockers.agents.src.agents.dca_agent.routes import delete_strategy
...
class TokenSwapAgent:
    ...
    def build_tx_for_bridge(self, bridge_params, src_chain_id, dest_chain_id):
        print()
        url = self.api_request_url("/bridge", bridge_params, src_chain_id, dest_chain_id)
    ...
    def get_response(self, message, chain_id, wallet_address):
        ...
        try:
            ...
            if result.tool_calls:
                ...
                return result.content, "assistant", "bridge agent"
